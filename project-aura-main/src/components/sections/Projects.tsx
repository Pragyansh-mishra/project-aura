...
const projects = [
  ...
  {
    title: "Calories Burn Prediction using Machine Learning",
    description:
      "Built a regression model to predict calories burned based on user health and activity data, integrated into a full-stack web application.",
    tech: ["Python", "Machine Learning", "Regression", "Full Stack"],
    gradient: "from-orange-500/20 to-red-500/20",
  },
  {
    title: "Aarohan Event Website",
    description:
      "Designed and developed the official website for Aarohan with a modern UI/UX to showcase events, schedules, and registration details through a responsive and user-friendly interface.",
    tech: ["React", "UI/UX", "Responsive Design", "Web Development"],
